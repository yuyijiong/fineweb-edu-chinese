...
import ray
from ray_read_parquet import load_hf_dataset
import setproctitle
...
if __name__ == "__main__":  # pragma: no cover
    ...
    #                ]
    #
    # data_dir_list+=get_scored_dir_list("/data/dataset/nlp/CN")
    # data_dir_list+=get_scored_dir_list("/data/dataset/CASIA-LM/ChineseWebText/cleaner_subset_score_3")
    ...
    # data_dir_list+=get_scored_dir_list("/data/dataset/nlp/CN",sign="scored")
    # data_dir_list+=get_scored_dir_list("//data/dataset/CASIA-LM/ChineseWebText/cleaner_subset",sign="scored")
